    ...
    if (typeof window !== 'undefined' && process.env.NEXT_PUBLIC_GOOGLE_CLIENT_ID) {
      ...
      const initGoogle = () => {
        if (window.google && window.google.accounts) {
          ...
          const container = document.getElementById('google-signup-container')
        ...
        <CardContent className="flex flex-col gap-4">
          ...
          <div className="w-full">
            {isGooglePending || isLoading ? (
              ...
              <div id="google-signup-container" className="w-full [&>div]:w-full [&>div>div]:w-full [&>div>div>div]:w-full" />
            )}
          </div>
