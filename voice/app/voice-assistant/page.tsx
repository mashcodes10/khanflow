...
import { ConversationThread } from '@/components/voice/conversation-thread'
              ...
              <div className="p-5">
                ...
                <div className="space-y-1.5">
                  {[
                    ...
                    { key: 'Esc', desc: 'Cancel recording' },
                    { key: '1-5', desc: 'Select option' },
                    { key: 'Enter', desc: 'Send text message' },
                  ].map((shortcut) => (
                    <div
                      key={shortcut.key}
                    ...
                    >
                      ...
                      <kbd className="flex items-center justify-center min-w-[2rem] h-5 px-1.5 rounded bg-muted border border-border-subtle text-[10px] font-mono text-muted-foreground">
                        {shortcut.key}
                      </kbd>
                    </div>
                  ))}
                ...
                <div className="mt-6 p-3 rounded-xl bg-accent/5 border border-accent/10">
                  ...
                  <p className="text-[11px] text-muted-foreground leading-relaxed">
                    Use urgency words like "ASAP" or "urgent" to
                    automatically set high priority. Include dates and
                    times for faster processing with fewer follow-up
                    questions.
                  </p>
                </div>
              </div>
